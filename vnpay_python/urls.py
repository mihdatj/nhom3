...
urlpatterns = [
    ...
    url(r'^checkout$', vnpay_python.views.checkout, name='checkout'),
    url(r'^category$', vnpay_python.views.category, name='category'),
    url(r'^product-detail\.html$', vnpay_python.views.product_detail, name='product_detail_html'),
    url(r'^product-detail$', vnpay_python.views.product_detail, name='product_detail'),
